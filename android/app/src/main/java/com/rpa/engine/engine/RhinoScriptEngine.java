...
public class RhinoScriptEngine {
    ...
    public void execute(String source, String paramsJson, Host host, AutoApi auto, File baseDir)
        ...
        cx.setOptimizationLevel(-1); // 观察器仅解释模式生效
        ...
        try {
            ...
            // 严格 JSON 解析后再注入，防止任务参数作为 JS 代码执行
            String params;
            try {
